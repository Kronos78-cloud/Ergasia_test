            ...
            <div class="map_container clearfix">
                ...
                <div class="column x3">
                    ...
                    <div class="column x5">
                        ...
                        <ul class="list">
                            <li class="header visited">ΕΜΒΟΛΙΑΣΤΙΚΑ ΚΕΝΤΡΑ COVID-19</li>
                      ...
                      <!--<div class="column x5">
                        ...
                        <ul class="list">
                            <li class="header togo">ΕΜΒΟΛΙΑΣΤΙΚΑ ΚΕΝΤΡΑ COVID-19</li>
...
@section('footer')
    <h2>Φωτογραφίες Εμβολιαστικών Κέντρων <small>[ <a href="{{ route('Upload.form') }}">Upload Photo</a> ]</small></h2>
